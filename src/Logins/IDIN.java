 ...
 * @author smart
 */
public class IDIN extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IDIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
