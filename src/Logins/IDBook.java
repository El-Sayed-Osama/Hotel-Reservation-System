 ...
 * @author smart
 */
public class IDBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Booking Guest Check", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 3, 48), new java.awt.Color(204, 204, 204))); // NOI18N
    ...
    public void display()
    {
        try
        {
            ...
            if(log==0)
            {
                JOptionPane.showMessageDialog(null, "Guest Data Exist", "Tolip Royal Hotel", JOptionPane.INFORMATION_MESSAGE);
                BookingRoomID Info = new BookingRoomID();
                Info.setVisible(true);
                setVisible(false);
            }
            else
            {
                JOptionPane.showMessageDialog(null, "Guest Data Not Exist", "Tolip Royal Hotel", JOptionPane.INFORMATION_MESSAGE);
                BookingRoom Info = new BookingRoom();
                Info.setVisible(true);
                setVisible(false);
            }
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IDBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
