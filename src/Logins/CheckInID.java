...
public class CheckInID extends javax.swing.JFrame {
    ...
    public CheckInID() {
        ...
        try
        {
            ...
            rs=st.executeQuery("select * from guest where id = '" + IDIN.ID + "'");
            rs.next();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckInID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
